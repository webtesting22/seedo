    ...
    return (
        <section id="ScrollingVideoAnimationContainer">
            <div className="ScrollingVideoHeading">
                <div>
                    <h1 className="PrimaryHeading">Ignite the Adventure </h1>
                    <h1 className="PrimaryHeading-color">Timeless Fun</h1>
                </div>
                <div>
                <svg width="100%" class="svg rotating-image" height="100%" viewBox="0 0 20 23" fill="red" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <hr />
                    <p className="paragraph">Our toys inspire creativity, spark joy, and create unforgettable moments of play for children of all ages.
