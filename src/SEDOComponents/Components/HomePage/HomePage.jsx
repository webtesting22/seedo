                    ...
                    <div id="ContentContainer">
                        ...
                        <div className="AnimatedSVGContainer">
                            <div>
                                ...
                                <h2 className="SecondaryHeading">Zoom into Fun: Your Ultimate Destination for Car Toys!</h2>
                                <p className="paragraph">Explore a world of thrilling car toys designed to spark creativity and imagination. From high-speed racers to classic collectibles, our collection has something for every car enthusiast, big or small. Start your adventure today and drive home the perfect toy!</p>
                            </div>
                        </div>
                    </div>
