                    ...
                    <div id="ContentContainer">
                        ...
                        <div className="AnimatedSVGContainer">
                            <div>
                                ...
                                <h2 className="SecondaryHeading">Our mission — saving the world one fire at a time</h2>
                                <p className="paragraph">The problem of wildfires is progressively becoming worse across the globe. We continue to witness billions of dollars in damage, thousands of lost lives, millions of destroyed acres of land and wild habitat. The 2018 California wildfires alone generated more than 91 million metric tons of CO2. Yet, no meaningful solution has been developed to date.</p>
                            </div>
                        </div>
                    </div>
