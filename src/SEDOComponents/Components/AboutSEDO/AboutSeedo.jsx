            ...
            <section id="AboutSEDOSection">
                <div>
                    ...
                    <div style={{ padding: "20px" }}>
                        <span>
                            <Link to="/" className="breadcrumb-link" style={{ color: "white" }}>Home</Link> <span style={{ color: "white" }}>&gt;{" "}</span>
                            <Link to="/aboutSeedo" className="breadcrumb-link" style={{ color: "white" }}>About Us</Link>
                        </span>
                    </div>
                        ...
                        <Row>
                            <Col lg={24}>
                                <div className="LeftSideContentContainer">
                                    {/* <h1>About SEDO</h1> */}
                                    <h2 className="PrimaryHeading-black" style={{color:"white"}}><svg width="100%" class="svg rotating-image" height="100%" viewBox="0 0 20 23" fill="red" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p style={{ color: "white" }}>Sanson is a leading innovator in consumer and trade promotions, trusted by major FMCG brands in India such as
